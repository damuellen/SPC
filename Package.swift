...
let package = Package(
  ...
  targets: [
    ...
    .target(name: "PhysicalQuantities", dependencies: ["Meteo", "Libc", "Helpers"], swiftSettings: swift),
    .target(name: "TransTES", dependencies: ["Helpers", "BlackBoxModel"], swiftSettings: swift),
    .target(name: "PinchPoint", 
      dependencies: ["CPikchr", "CIAPWSIF97", "Helpers", "PhysicalQuantities", "BlackBoxModel",
