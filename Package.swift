...
var package = Package(
  ...
  products: [
    ...
    .executable(name: "Playground", targets: ["Playground"]),  // .library(name: "BlackBoxModel", type: .dynamic, targets: ["BlackBoxModel"]),
  ],
  dependencies: [
  ...
  targets: [
    .target(name: "Config", swiftSettings: swift), .target(name: "DateGenerator", swiftSettings: swift),
    .target(name: "CPikchr", cSettings: [c]), .target(name: "CSPA", cSettings: [c]), .target(name: "CSOLPOS", cSettings: [c]),
    .target(name: "SolarPosition", dependencies: ["Utilities", "DateGenerator", "CSOLPOS", "CSPA"], swiftSettings: swift),
    ...
    .target(
      ...
      swiftSettings: swift, linkerSettings: [.linkedLibrary("sqlite3.lib", win), linker]), 
    ...
    .target(name: "Meteo", dependencies: ["DateGenerator", "SolarPosition", "Utilities"], swiftSettings: swift),
    // .executableTarget(name: "Benchmarking",
    //   dependencies: ["Meteo", "Benchmark", "BlackBoxModel"],
    //   swiftSettings: swift),
    .executableTarget(name: "Playground", dependencies: ["Utilities"], swiftSettings: swift, linkerSettings: [linker]),
    .executableTarget(
      name: "SolarFieldCalc",
      dependencies: [
    ...
    .executableTarget(
      ...
      dependencies: [
        ...
        .product(name: "xlsxwriter", package: "xlsxwriter.swift")],
      swiftSettings: swift, linkerSettings: [linker]), 
    .executableTarget(name: "TransTES", dependencies: ["Utilities"], swiftSettings: swift, linkerSettings: [linker]),
    .executableTarget(
      name: "SunOl",
      dependencies: [
    ...
    .executableTarget(
      ...
      dependencies: [
        ...
        .product(name: "xlsxwriter", package: "xlsxwriter.swift")],
      swiftSettings: swift, linkerSettings: [linker]),
    .testTarget(name: "MeteoTests", dependencies: ["Utilities", "DateGenerator", "SolarPosition", "Meteo"]),
    ...
    .testTarget(name: "BlackBoxModelTests", dependencies: ["Config", "Meteo", "SolarPosition", "BlackBoxModel"]),
  ],
