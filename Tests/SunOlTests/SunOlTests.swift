  ...
  func testsCalculation() {
    ...
    for j in 0..<4 {
      ...
      if j == 0 {
        ...
        XCTAssertEqual(hour4[26634], 2.57, accuracy: 0.05, "DY350")
        XCTAssertEqual(hour4[35394], 0.00, accuracy: 0.05, "DZ350")
        XCTAssertEqual(hour4[44154], 0.00, accuracy: 0.05, "EA350")
        XCTAssertEqual(hour4[52914], 161.25, accuracy: 0.05, "EB349")
        XCTAssertEqual(hour4[61674], 0.00, accuracy: 0.05, "EC349")
        XCTAssertEqual(hour4[70434], 0.00, accuracy: 0.05, "ED349")
        XCTAssertEqual(hour4[79194], 1406.73, accuracy: 0.05, "EE349")
        XCTAssertEqual(hour4[87954], 0.00, accuracy: 0.05, "EF349")
        XCTAssertEqual(hour4[96714], 0.00, accuracy: 0.05, "EG349")
        XCTAssertEqual(hour4[105474], 0.00, accuracy: 0.05, "EH349")
        XCTAssertEqual(hour4[9113], 0.00, accuracy: 0.05, "DW349")
        XCTAssertEqual(hour4[122994], 1406.73, accuracy: 0.05, "EJ349")
        XCTAssertEqual(hour4[131754], 332.30, accuracy: 0.05, "EK349")
        XCTAssertEqual(hour4[140514], 0.00, accuracy: 0.05, "EL349")
        XCTAssertEqual(hour4[149274], 0.00, accuracy: 0.05, "EM349")
        XCTAssertEqual(hour4[158034], 0.00, accuracy: 0.05, "EN349")
        XCTAssertEqual(hour4[166794], 0.00, accuracy: 0.05, "EO349")
        XCTAssertEqual(hour4[175554], 0.00, accuracy: 0.05, "EP349")
        XCTAssertEqual(hour4[184314], 0.00, accuracy: 0.05, "EQ349")
        XCTAssertEqual(hour4[193074], 232.51, accuracy: 0.05, "ER349")
        XCTAssertEqual(hour4[201834], 36.00, accuracy: 0.05, "ES349")
        XCTAssertEqual(hour4[210594], 5.59, accuracy: 0.05, "ET349")
        XCTAssertEqual(hour4[219354], 0.00, accuracy: 0.05, "EU349")
        XCTAssertEqual(hour4[228114], 116.52, accuracy: 0.05, "EW349")
        XCTAssertEqual(hour4[236874], 116.52, accuracy: 0.05, "EX349")
        XCTAssertEqual(hour4[245634], 49.21, accuracy: 0.05, "EY349")
        XCTAssertEqual(hour4[254394], 15.00, accuracy: 0.05, "EZ349")
        XCTAssertEqual(hour4[263154], 0.00, accuracy: 0.05, "FA349")
        XCTAssertEqual(hour4[271914], 0.00, accuracy: 0.05, "FB349")
        XCTAssertEqual(hour4[280674], 97.06, accuracy: 0.05, "FC349")
        XCTAssertEqual(hour4[289434], 0.00, accuracy: 0.05, "FD349")
        XCTAssertEqual(hour4[298194], 0.00, accuracy: 0.05, "FE349")
        XCTAssertEqual(hour4[306954], 50.00, accuracy: 0.05, "FF349")
        XCTAssertEqual(hour4[315714], 13.34, accuracy: 0.05, "FG349")
        XCTAssertEqual(hour4[324474], 86.66, accuracy: 0.05, "FH349")
        XCTAssertEqual(hour4[333234], 34.37, accuracy: 0.05, "FI349")
        XCTAssertEqual(hour4[341994], 11.26, accuracy: 0.05, "FJ349")
        XCTAssertEqual(hour4[350754], 6.29, accuracy: 0.05, "FK349")
        XCTAssertEqual(hour4[359514], 65.00, accuracy: 0.05, "FL349")
        XCTAssertEqual(hour4[368274], 50.00, accuracy: 0.05, "FM349")
        XCTAssertEqual(hour4[377034], 205.66, accuracy: 0.05, "FN349")
        XCTAssertEqual(hour4[385794], 205.66, accuracy: 0.05, "FO349")
        XCTAssertEqual(hour4[394554], 87.36, accuracy: 0.05, "FP349")
        XCTAssertEqual(hour4[403314], 0.00, accuracy: 0.05, "FQ349")
        XCTAssertEqual(hour4[412074], 0.00, accuracy: 0.05, "FR349")
        XCTAssertEqual(hour4[420834], 30.62, accuracy: 0.05, "FS349")
        XCTAssertEqual(hour4[429594], 19.38, accuracy: 0.05, "FT349")
        XCTAssertEqual(hour4[438354], 51.88, accuracy: 0.05, "FU349")
        XCTAssertEqual(hour4[447114], 48.12, accuracy: 0.05, "FV349")
        XCTAssertEqual(hour4[455874], 21.56, accuracy: 0.05, "FW349")
        XCTAssertEqual(hour4[464634], 0.00, accuracy: 0.05, "FX349")
        XCTAssertEqual(hour4[473394], 4.74, accuracy: 0.05, "FY349")
        XCTAssertEqual(hour4[482154], 0.00, accuracy: 0.05, "FZ349")
        XCTAssertEqual(hour4[490914], 0.00, accuracy: 0.05, "GA349")
      }

      model.night(case: j, day1: &day1, hour3: hour3, hour4: hour4)
      day1.head(2, steps: 365)
      if j == 0 {
      ...
      if j == 2 {
        XCTAssertEqual(day17[7996], 1.00, accuracy: 0.1, "AAO334")
        XCTAssertEqual(day17[8361], 825.88, accuracy: 0.1, "AAP334")
        XCTAssertEqual(day17[8726], -874.89, accuracy: 0.1, "AAQ334")
        XCTAssertEqual(day17[9091], 817.62, accuracy: 0.1, "AAR334")
        XCTAssertEqual(day17[9456], -540.24, accuracy: 0.1, "AAS334")
        XCTAssertEqual(day17[9821], 473.77, accuracy: 0.1, "AAT334")
        XCTAssertEqual(day17[10186], 137.83, accuracy: 0.1, "AAU334")
        XCTAssertEqual(day17[10551], 185.71, accuracy: 0.1, "AAV334")
        XCTAssertEqual(day17[10916], 185.71, accuracy: 0.1, "AAW334")
        XCTAssertEqual(day17[11281], 195.42, accuracy: 0.1, "AAX334")
        XCTAssertEqual(day17[11646], 195.42, accuracy: 0.1, "AAY334")
        XCTAssertEqual(day17[12011], 1.20, accuracy: 0.1, "AAZ334")
        XCTAssertEqual(day17[12376], 1.20, accuracy: 0.1, "ABA334")
        XCTAssertEqual(day17[12741], 14.51, accuracy: 0.1, "ABB334")
        XCTAssertEqual(day17[13106], -8.72, accuracy: 0.1, "ABC334")
        XCTAssertEqual(day17[13471], 0.77, accuracy: 0.1, "ABD334")
        XCTAssertEqual(day17[13836], 0.78, accuracy: 0.1, "ABF334")
        XCTAssertEqual(day17[14201], 1060.28, accuracy: 0.1, "ABG334")
        XCTAssertEqual(day17[14566], -61.83, accuracy: 0.1, "ABH334")
        XCTAssertEqual(day17[14931], 1049.68, accuracy: 0.1, "ABI334")
        XCTAssertEqual(day17[15296], -61.22, accuracy: 0.1, "ABJ334")
        XCTAssertEqual(day17[15661], 886.66, accuracy: 0.1, "ABK334")
        XCTAssertEqual(day17[16026], 706.98, accuracy: 0.1, "ABL334")
        XCTAssertEqual(day17[16391], 185.71, accuracy: 0.1, "ABM334")
        XCTAssertEqual(day17[16756], 185.71, accuracy: 0.1, "ABN334")
        XCTAssertEqual(day17[17121], 309.36, accuracy: 0.1, "ABO334")
        XCTAssertEqual(day17[17486], 195.42, accuracy: 0.1, "ABP334")
        XCTAssertEqual(day17[17851], 101.37, accuracy: 0.1, "ABQ334")
        XCTAssertEqual(day17[18216], 1.20, accuracy: 0.1, "ABR334")
        XCTAssertEqual(day17[18581], 16.16, accuracy: 0.1, "ABS334")
        XCTAssertEqual(day17[18946], 2.39, accuracy: 0.1, "ABT334")
        XCTAssertEqual(day17[19311], 0.98, accuracy: 0.1, "ABU334")
        XCTAssertEqual(day17[19676], 1841.43, accuracy: 0.1, "ABW334")
        XCTAssertEqual(day17[20041], 2267.78, accuracy: 0.1, "ABX334")
        XCTAssertEqual(day17[20406], 48.72, accuracy: 0.1, "ABY334")
        XCTAssertEqual(day17[20771], 0.00, accuracy: 0.1, "ABZ334")
        XCTAssertEqual(day17[21136], 191.23, accuracy: 0.1, "ACA334")
        XCTAssertEqual(day17[21501], 398.13, accuracy: 0.1, "ACB334")
        XCTAssertEqual(day17[21866], 4283.95, accuracy: 0.1, "ACC334")
        XCTAssertEqual(day17[22231], 63.34, accuracy: 0.1, "ACD334")
        XCTAssertEqual(day17[22596], 400.00, accuracy: 0.1, "ACE334")
        XCTAssertEqual(day17[22961], 0.00, accuracy: 0.1, "ACF334")
        XCTAssertEqual(day17[23326], 782.16, accuracy: 0.1, "ACG334")
        XCTAssertEqual(day17[23691], 493.99, accuracy: 0.1, "ACH334")
        XCTAssertEqual(day17[24056], 189.32, accuracy: 0.1, "ACI334")
        XCTAssertEqual(day17[24421], 394.15, accuracy: 0.1, "ACJ334")
        XCTAssertEqual(day17[24786], 692.68, accuracy: 0.1, "ACK334")
        XCTAssertEqual(day17[25151], 0.00, accuracy: 0.1, "ACL334")
        XCTAssertEqual(day17[25516], 161.05, accuracy: 0.1, "ACM334")
        XCTAssertEqual(day17[25881], 34.15, accuracy: 0.1, "ACN334")
        XCTAssertEqual(day17[26246], 51.36, accuracy: 0.1, "ACO334")
        XCTAssertEqual(day17[26611], 0.00, accuracy: 0.1, "ACP334")
        XCTAssertEqual(day17[26976], 310.65, accuracy: 0.1, "ACQ334")
        XCTAssertEqual(day17[27341], 0.00, accuracy: 0.1, "ACR334")
        XCTAssertEqual(day17[27706], 64.09, accuracy: 0.1, "ACS334")
        XCTAssertEqual(day17[28071], 343.01, accuracy: 0.1, "ACT334")
        XCTAssertEqual(day17[28436], 50.84, accuracy: 0.1, "ACU334")
        XCTAssertEqual(day17[28801], 350.89, accuracy: 0.1, "ACV334")
        XCTAssertEqual(day17[29166], 58.72, accuracy: 0.1, "ACW334")
        XCTAssertEqual(day17[29531], 373.46, accuracy: 0.1, "ACX334")
        XCTAssertEqual(day17[29896], 64.09, accuracy: 0.1, "ACY334")
        XCTAssertEqual(day17[30261], 400.00, accuracy: 0.1, "ACZ334")
        XCTAssertEqual(day17[30626], 15.00, accuracy: 0.1, "ADA334")
        XCTAssertEqual(day17[30991], 9.00, accuracy: 0.1, "ADB334")
        XCTAssertEqual(day17[31356], 14.00, accuracy: 0.1, "ADC334")
        XCTAssertEqual(day17[31721], 0.00, accuracy: 0.1, "ADD334")
        XCTAssertEqual(day17[32086], 1797.74, accuracy: 0.1, "ADF334")
        XCTAssertEqual(day17[32451], 2314.94, accuracy: 0.1, "ADG334")
        XCTAssertEqual(day17[32816], 48.76, accuracy: 0.1, "ADH334")
        XCTAssertEqual(day17[33181], 0.00, accuracy: 0.1, "ADI334")
        XCTAssertEqual(day17[33546], 183.11, accuracy: 0.1, "ADJ334")
        XCTAssertEqual(day17[33911], 399.58, accuracy: 0.1, "ADK334")
        XCTAssertEqual(day17[34276], 4281.53, accuracy: 0.1, "ADL334")
        XCTAssertEqual(day17[34641], 59.85, accuracy: 0.1, "ADM334")
        XCTAssertEqual(day17[35006], 402.76, accuracy: 0.1, "ADN334")
        XCTAssertEqual(day17[35371], 0.00, accuracy: 0.1, "ADO334")
        XCTAssertEqual(day17[35736], 763.46, accuracy: 0.1, "ADP334")
        XCTAssertEqual(day17[36101], 504.32, accuracy: 0.1, "ADQ334")
        XCTAssertEqual(day17[36466], 181.28, accuracy: 0.1, "ADR334")
        XCTAssertEqual(day17[36831], 395.58, accuracy: 0.1, "ADS334")
        XCTAssertEqual(day17[37196], 690.91, accuracy: 0.1, "ADT334")
        XCTAssertEqual(day17[37561], 0.00, accuracy: 0.1, "ADU334")
        XCTAssertEqual(day17[37926], 160.52, accuracy: 0.1, "ADV334")
        XCTAssertEqual(day17[38291], 34.19, accuracy: 0.1, "ADW334")
        XCTAssertEqual(day17[38656], 47.73, accuracy: 0.1, "ADX334")
        XCTAssertEqual(day17[39021], 0.00, accuracy: 0.1, "ADY334")
        XCTAssertEqual(day17[39386], 310.64, accuracy: 0.1, "ADZ334")
        XCTAssertEqual(day17[39751], 0.00, accuracy: 0.1, "AEA334")
        XCTAssertEqual(day17[40116], 68.20, accuracy: 0.1, "AEB334")
        XCTAssertEqual(day17[40481], 339.18, accuracy: 0.1, "AEC334")
        XCTAssertEqual(day17[40846], 47.25, accuracy: 0.1, "AED334")
        XCTAssertEqual(day17[41211], 355.05, accuracy: 0.1, "AEE334")
        XCTAssertEqual(day17[41576], 63.12, accuracy: 0.1, "AEF334")
        XCTAssertEqual(day17[41941], 368.89, accuracy: 0.1, "AEG334")
        XCTAssertEqual(day17[42306], 68.20, accuracy: 0.1, "AEH334")
        XCTAssertEqual(day17[42671], 402.76, accuracy: 0.1, "AEI334")
        XCTAssertEqual(day17[43036], 15.00, accuracy: 0.1, "AEJ334")
        XCTAssertEqual(day17[43401], 9.00, accuracy: 0.1, "AEK334")
