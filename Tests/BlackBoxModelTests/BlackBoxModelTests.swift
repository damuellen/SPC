...
class BlackBoxModelTests: XCTestCase {
  ...
  func testsSummer() {
    ...
    XCTAssertEqual(result.electric.net, 2248, accuracy: tol, "electric.net")
    ...
    XCTAssertEqual(result.thermal.production.megaWatt, 5773, accuracy: tol, "thermal.production")
  ...
  func testsWinter() {    
    ...
    XCTAssertEqual(result.thermal.startUp.megaWatt, 0, accuracy: tol, "thermal.startUp")
    XCTAssertEqual(result.thermal.production.megaWatt, 3990, accuracy: tol, "thermal.production")
