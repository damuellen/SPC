...
public enum Report {
  ...
  public static var description: String {
    ...
    d += "Annual Average Solar Field Availability [%]:"
      >< "\(Plant.availability[0].solarField.percentage)"
    d += "Average Percentage of Broken HCE [%]:"
      >< "\(Plant.availability[0].breakHCE.percentage)"
    d += "Average Percentage of HCE with Lost Vacuum [%]:"
      >< "\(Plant.availability[0].airHCE.percentage)"
    d += "Average Percentage of Flourescent HCE [%]:"
      >< "\(Plant.availability[0].fluorHCE.percentage)"
    d += "Average Mirror Reflectivity [%]:"
      >< "\(Plant.availability[0].reflMirror.percentage)"
    d += "Broken Mirrors [%]:"
      >< "\(Plant.availability[0].missingMirros.percentage)"
