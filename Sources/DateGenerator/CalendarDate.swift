...
@frozen public struct CalendarDate {
  
  public static var current = CalendarDate()
   
  public var isDaytime: Bool? = nil
  ...
  @inlinable public static func setCurrent(_ date: Date) {
    current = .init(date)
  }
}
...
extension CalendarDate {
  @usableFromInline init(_ date : Date) {
