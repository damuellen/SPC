extension TunOl {
  func d22(_ h: inout [Double])  {
    ...
    h.sumOf(N, days: days, at: DM, condition: S, predicate: notZero)
    ...
    h.sumOf(AU, days: days, at: DN, condition: AH, predicate: notZero)
    /// Available day op  CSP heat
    // =SUMIF(Calculation!$U$5:$U$8764,"="&$A3,Calculation!$N$5:$N$8764)-DM3
    h.sum(days: days, range: N, at: DO)
    ...
    h.sumOf(TX, days: days, at: DT, condition: S, predicate: { $0.isZero })
    ...
    h.sumOf(UB, days: days, at: DU, condition: AH, predicate: { $0.isZero })
    ...
    h.sumOf(AF, days: days, at: DV, condition: S, predicate: notZero)
    ...
    h.sumOf(TY, days: days, at: DY, condition: S, predicate: { $0.isZero })
    ...
    h.sumOf(UC, days: days, at: DZ, condition: AH, predicate: { $0.isZero })
    ...
    h.sumOf(X, days: days, at: EA, condition: S, predicate: { $0.isZero })
    ...
    h.sumOf(V, days: days, at: EB, condition: S, predicate: notZero)
    ...
    h.sumOf(W, days: days, at: EE, condition: S, predicate: notZero)
    ...
    h.sumOf(Y, days: days, at: EH, condition: S, predicate: notZero)
    ...
    h.sumOf(AE, days: days, at: EM, condition: S) { $0.isZero }
    // MIN(SUMIFS(CalculationAE5:AE8763,CalculationU5:U8763,"="A6,CalculationS5:S8763,"=0"),BESS_cap_ud/BESS_chrg_eff)
    ...
    h.sumOf(TZ, days: days, at: EN, condition: S, predicate: { $0.isZero })
    ...
    h.sumOf(UD, days: days, at: EO, condition: AH, predicate: { $0.isZero })
    ...
    h.sumOf(AA, days: days, at: EP, condition: S, predicate: notZero)
    ...
    h.sumOf(AB, days: days, at: ES, condition: S, predicate: notZero)
    ...
    h.sumOf(AC, days: days, at: EV, condition: S, predicate: notZero)
    ...
    h.sumOf(AD, days: days, at: EY, condition: S, predicate: notZero)
