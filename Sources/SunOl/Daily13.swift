extension TunOl {
  func d13(_ d13: inout [Double], case j: Int) {
    // d1
    let (Z, AA, AB, AC, AD, AE, AF, AG, AH, AI, AM) = (8030, 8395, 8760, 9125, 9490, 9855, 10220, 10585, 10950, 11315, 12775)
    // d5
    let (_, _, _, _, _, _, _, _, _, _, _, _, FK, _, _, _, _, _, _, _, FS, FT, _, FV, FW, _, FY, FZ, GA, _, _, _, GE, GF, GG, GH, GI, _, GK, GL, _, GN, GO, _, GQ, GR, _) = (
    ...
    // d6
    let (_, _, _, _, _, _, _, _, _, _, _, _, HG, _, _, _, _, _, _, _, HO, HP, _, HR, HS, _, HU, HV, HW, _, _, _, IA, IB, IC, ID, IE, _, IG, IH, _, IJ, IK, _, IM, IN, _) = (
    ...
    let (
      IQ, IR, IS, IT, IU, IV, IW, IX, IY, IZ, JA, JB, JC, JD, JE, JF, JG, JH, JI, JJ, JK, JL, JM, JN, _, JP, JQ, JR, JS, JT, JU, JV, JW, JX, JY, JZ, KA, KB, KC, KD, KE, KF, KG, _, KI,
      KJ, KK, KL, KM, KN, KO, KP, KQ, KR, KS, KT, KU, KV, KW, KX, KY, KZ
    ) = (
