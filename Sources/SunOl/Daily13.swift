extension TunOl {
  func d13(_ d13: inout [Double], case j: Int, d10: [Double], d11: [Double], d12: [Double]) {
    ...
    for i in 0..<365 { d13[ddIR + i] = d12[HO + i] + d12[IA + i] - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) * d13[ddAM + i]) - max(0, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[ddAM + i]) - d12[HR + i]) / El_boiler_eff - min(d12[HU + i], max(.zero, d12[HG + i] - d12[IC + i]) / BESS_chrg_eff) }
    ...
    for i in 0..<365 { d13[ddIS + i] = d11[FT + i] + d11[GF + i] - d10[Z + i] - max(.zero, d10[AB + i] - d11[FW + i]) / El_boiler_eff - min(d11[FZ + i], max(.zero, d11[FK + i] - d12[GG + i]) / BESS_chrg_eff) }
    ...
    for i in 0..<365 { d13[ddIT + i] = d11[FV + i] + max(.zero, d11[FS + i] + d11[GE + i] - d10[Z + i] - min(d11[FY + i], max(.zero, d11[FK + i] - d12[GG + i]) / BESS_chrg_eff)) * El_boiler_eff - d10[AB + i] }
    ...
    for i in 0..<365 { d13[ddIU + i] = d12[HR + i] + max(.zero, d12[HO + i] + d12[IA + i] - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) * d13[ddAM + i]) - min(d12[HU + i], max(.zero, d12[HG + i] - d12[IC + i]) / BESS_chrg_eff)) * El_boiler_eff - (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[ddAM + i]) }
    ...
    for i in 0..<365 { d13[ddIV + i] = d11[FW + i] + max(.zero, d11[FT + i] + d11[GF + i] - d10[Z + i] - min(d11[FZ + i], max(.zero, d11[FK + i] - d12[GG + i]) / BESS_chrg_eff)) * El_boiler_eff - d10[AB + i] }
    ...
    for i in 0..<365 { d13[ddIX + i] = d12[ID + i] - max(.zero, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[ddAM + i]) - d12[HR + i]) / El_boiler_eff }
    ...
    for i in 0..<365 {
      ...
      d13[ddIZ + i] = d11[FY + i] - max(.zero, d11[FK + i] - d11[GG + i]) / BESS_chrg_eff
      // HU6-MAX(0,HG6-IC6)/BESS_chrg_eff
      d13[ddJA + i] = d12[HU + i] - max(.zero, d12[HG + i] - d12[IC + i]) / BESS_chrg_eff
      // FZ6-MAX(0,FK6-GG6)/BESS_chrg_eff
      d13[ddJB + i] = d11[FZ + i] - max(.zero, d11[FK + i] - d11[GG + i]) / BESS_chrg_eff
    }
    ...
    for i in 0..<365 { d13[ddJC + i] = d11[GE + i] - max(.zero, -(d11[FS + i] - d10[Z + i] - max(0, d10[AB + i] - d11[FV + i]) / El_boiler_eff - min(d11[FY + i], max(.zero, d11[FK + i] - d12[GG + i]) / BESS_chrg_eff))) }
    ...
    for i in 0..<365 {
      ...
      d13[ddJD + i] = d12[IA + i] - max(.zero, -(d12[HO + i] - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) * d13[ddAM + i]) - max(.zero, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[ddAM + i]) - d12[HR + i]) / El_boiler_eff - min(d12[HU + i], max(.zero, d12[HG + i] - d12[IC + i]) / BESS_chrg_eff)))
    }
    ...
    for i in 0..<365 { d13[ddJE + i] = d11[GF + i] - max(.zero, -(d11[FT + i] - d10[Z + i] - max(0, d10[AB + i] - d11[FW + i]) / El_boiler_eff - min(d11[FZ + i], max(.zero, d11[FK + i] - d12[GG + i]) / BESS_chrg_eff))) }
    ...
    for i in 0..<365 { d13[ddJG + i] = d12[IG + i] - (d10[AD + i] + (d10[AE + i] - d10[AD + i]) * d13[ddAM + i]) }
    ...
    for i in 0..<365 { d13[ddJJ + i] = d12[IJ + i] - (d10[AF + i] + (d10[AG + i] - d10[AF + i]) * d13[ddAM + i]) }
    ...
    for i in 0..<365 { d13[ddJM + i] = d12[IM + i] - (d10[AH + i] + (d10[AI + i] - d10[AH + i]) * d13[ddAM + i]) }
      ...
      d13[ddJQ + i] = iff(
        ...
        round(
          (d11[FS + i] + (d11[FT + i] - d11[FS + i]) * d13[dddJP + i]) + (d11[GE + i] + (d11[GF + i] - d11[GE + i]) * d13[dddJP + i]) - d10[Z + i] - max(.zero, d10[AB + i] - (d11[FV + i] + (d11[FW + i] - d11[FV + i]) * d13[dddJP + i])) / El_boiler_eff
            - min((d11[FY + i] + (d11[FZ + i] - d11[FY + i]) * d13[dddJP + i]), max(.zero, d11[FK + i] - d12[GG + i]) / BESS_chrg_eff), 5))
    }
    ...
    for i in 0..<365 {
      d13[ddJR + i] = iff(
        d13[ddJP + i].isZero, .zero,
        round(
          (d12[HO + i] + (d12[HP + i] - d12[HO + i]) * d13[dddJP + i]) + (d12[IA + i] + (d12[IB + i] - d12[IA + i]) * d13[dddJP + i]) - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) * d13[ddAM + i]) - max(.zero, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[ddAM + i]) - (d12[HR + i] + (d12[HS + i] - d12[HR + i]) * d13[dddJP + i])) / El_boiler_eff
            - min((d12[HU + i] + (d12[HV + i] - d12[HU + i]) * d13[dddJP + i]), max(.zero, d12[HG + i] - d12[IC + i]) / BESS_chrg_eff), 5))
    }
      ...
      d13[ddJS + i] = iff(
        ...
        round(
          (d11[FV + i] + (d11[FW + i] - d11[FV + i]) * d13[dddJP + i]) + max(.zero, (d11[FS + i] + (d11[FT + i] - d11[FS + i]) * d13[dddJP + i]) + (d11[GE + i] + (d11[GF + i] - d11[GE + i]) * d13[dddJP + i]) - d10[Z + i]) * El_boiler_eff
            - min((d11[FY + i] + (d11[FZ + i] - d11[FY + i]) * d13[dddJP + i]), max(.zero, d11[FK + i] - d12[GG + i]) / BESS_chrg_eff) - d10[AB + i], 5))
    }
    ...
    for i in 0..<365 {
      d13[ddJT + i] = iff(
        d13[ddJP + i].isZero, .zero,
        round(
          (d12[HR + i] + (d12[HS + i] - d12[HR + i]) * d13[dddJP + i]) + max(.zero, (d12[HO + i] + (d12[HP + i] - d12[HO + i]) * d13[dddJP + i]) + (d12[IA + i] + (d12[IB + i] - d12[IA + i]) * d13[dddJP + i]) - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) * d13[ddAM + i])) * El_boiler_eff
            - min((d12[HU + i] + (d12[HV + i] - d12[HU + i]) * d13[dddJP + i]), max(.zero, d12[HG + i] - d12[IC + i]) / BESS_chrg_eff) - (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[ddAM + i]), 5))
    }
    ...
    for i in 0..<365 { d13[ddJV + i] = iff(d13[ddJP + i].isZero, .zero, round((d12[ID + i] + (d12[IE + i] - d12[ID + i]) * d13[dddJP + i]) - max(.zero, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[ddAM + i]) - (d12[HR + i] + (d12[HS + i] - d12[HR + i]) * d13[dddJP + i])) / El_boiler_eff, 5)) }
    ...
    for i in 0..<365 { d13[ddJW + i] = iff(d13[ddJP + i].isZero, .zero, round((d11[FY + i] + (d11[FZ + i] - d11[FY + i]) / Overall_harmonious_range * (d13[ddJP + i] - Overall_harmonious_min_perc)) - max(.zero, d11[FK + i] - d11[GG + i]) / BESS_chrg_eff, 5)) }
    ...
    for i in 0..<365 { d13[ddJX + i] = iff(d13[ddJP + i].isZero, .zero, round((d12[HU + i] + (d12[HV + i] - d12[HU + i]) / Overall_harmonious_range * (d13[ddJP + i] - Overall_harmonious_min_perc)) - max(.zero, d12[HG + i] - d12[IC + i]) / BESS_chrg_eff, 5)) }
      ...
      d13[ddJY + i] = iff(
        ...
        round(
          (d11[GE + i] + (d11[GF + i] - d11[GE + i]) * d13[dddJP + i])
            - max(.zero, -((d11[FS + i] + (d11[FT + i] - d11[FS + i]) * d13[dddJP + i]) - d10[Z + i] - max(.zero, d10[AB + i] - (d11[FV + i] + (d11[FW + i] - d11[FV + i]) * d13[dddJP + i])) / El_boiler_eff - min((d11[FY + i] + (d11[FZ + i] - d11[FY + i]) * d13[dddJP + i]), max(.zero, d11[FK + i] - d12[GG + i]) / BESS_chrg_eff))), 5))
    }
      ...
      d13[ddJZ + i] = iff(
        ...
        round(
          (d12[IA + i] + (d12[IB + i] - d12[IA + i]) * d13[dddJP + i])
            - max(
              .zero,
              -((d12[HO + i] + (d12[HP + i] - d12[HO + i]) * d13[dddJP + i]) - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j]) * (d10[AM + i] - equiv_harmonious_min_perc[j])) - max(
                .zero, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j]) * (d10[AM + i] - equiv_harmonious_min_perc[j])) - (d12[HR + i] + (d12[HS + i] - d12[HR + i]) * d13[dddJP + i])) / El_boiler_eff
                - min((d12[HU + i] + (d12[HV + i] - d12[HU + i]) * d13[dddJP + i]), max(.zero, d12[HG + i] - d12[IC + i]) / BESS_chrg_eff))), 5))
    }
    ...
    for i in 0..<365 { d13[ddKA + i] = iff(d13[ddJP + i].isZero, .zero, round((d11[GK + i] + (d11[GL + i] - d11[GK + i]) * d13[dddJP + i]) - d10[AD + i], 5)) }
    ...
    for i in 0..<365 { d13[ddKB + i] = iff(d13[ddJP + i].isZero, .zero, round(d12[IG + i] + (d12[IH + i] - d12[IG + i]) * d13[dddJP + i] - (d10[AD + i] + (d10[AE + i] - d10[AD + i]) * d13[ddAM + i]), 5)) }
    ...
    for i in 0..<365 { d13[ddKC + i] = iff(d13[ddJP + i].isZero, .zero, round((d11[GN + i] + (d11[GO + i] - d11[GN + i]) * d13[dddJP + i]) - d10[AF + i], 5)) }
    ...
    for i in 0..<365 { d13[ddKD + i] = iff(d13[ddJP + i].isZero, .zero, round(d12[IJ + i] + (d12[IK + i] - d12[IJ + i]) * d13[dddJP + i] - (d10[AF + i] + (d10[AG + i] - d10[AF + i]) * d13[ddAM + i]), 5)) }
    ...
    for i in 0..<365 { d13[ddKF + i] = iff(d13[ddJP + i].isZero, .zero, round(d12[IM + i] + (d12[IN + i] - d12[IM + i]) * d13[dddJP + i] - (d10[AH + i] + (d10[AI + i] - d10[AH + i]) * d13[ddAM + i]), 5)) }
    ...
    for i in 0..<365 {
      d13[ddKG + i] = iff(
        or(d13[ddJP + i].isZero, d13[ddJQ + i] < .zero, d13[ddJS + i] < .zero, d13[ddJU + i] < .zero, d13[ddJW + i] < .zero, d13[ddJY + i] < .zero, d13[ddKA + i] < .zero, d13[ddKC + i] < .zero, d13[ddKE + i] < .zero), 0,
        min(
    ...
    for i in 0..<365 {
      d13[ddKI + i] = iff(
        or(d13[ddIQ + i] < .zero, d13[ddIT + i] < .zero, d13[ddIW + i] < .zero, d13[ddIZ + i] < .zero, d13[ddJC + i] < .zero, d13[ddJF + i] < .zero, d13[ddJI + i] < .zero, d13[ddJL + i] < .zero), 0,
        min(
    ...
    for i in 0..<365 {
      d13[dddKI + i] = equiv_harmonious_range[j] < 1E-10 ? 1 : (d13[ddKI + i] - equiv_harmonious_min_perc[j]) / equiv_harmonious_range[j]
    ...
    for i in 0..<365 {
      d13[ddKJ + i] = iff(
        ...
        round(
          (d11[FS + i] + (d12[HO + i] - d11[FS + i]) * d13[ddAMKI + i]) + (d11[GE + i] + (d12[IA + i] - d11[GE + i]) * d13[ddAMKI + i]) - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) * d13[dddKI + i]) - max(.zero, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[dddKI + i]) - (d11[FV + i] + (d12[HR + i] - d11[FV + i]) * d13[ddAMKI + i])) / El_boiler_eff
            - min((d11[FY + i] + (d12[HU + i] - d11[FY + i]) * d13[ddAMKI + i]), max(.zero, (d11[FK + i] + (d12[HG + i] - d11[FK + i]) * d13[ddAMKI + i]) - (d11[GG + i] + (d12[IC + i] - d11[GG + i]) * d13[ddAMKI + i])) / BESS_chrg_eff), 5))
    }
    ...
    for i in 0..<365 {
      d13[ddKK + i] = iff(
        d13[ddKI + i].isZero, .zero,
        round(
          (d11[FT + i] + (d12[HP + i] - d11[FT + i]) * d13[ddAMKI + i]) + (d11[GF + i] + (d12[IB + i] - d11[GF + i]) * d13[ddAMKI + i]) - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) * d13[dddKI + i]) - max(.zero, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[dddKI + i]) - (d11[FW + i] + (d12[HS + i] - d11[FW + i]) * d13[ddAMKI + i])) / El_boiler_eff
            - min((d11[FZ + i] + (d12[HV + i] - d11[FZ + i]) * d13[ddAMKI + i]), max(.zero, (d11[FK + i] + (d12[HG + i] - d11[FK + i]) * d13[ddAMKI + i]) - (d11[GG + i] + (d12[IC + i] - d11[GG + i]) * d13[ddAMKI + i])) / BESS_chrg_eff), 5))
    }
    ...
    for i in 0..<365 {
      d13[ddKL + i] = iff(
        d13[ddKI + i].isZero, .zero,
        round(
          (d11[FV + i] + (d12[HR + i] - d11[FV + i]) * d13[ddAMKI + i]) + (max(.zero, (d11[FS + i] + (d12[HO + i] - d11[FS + i]) * d13[ddAMKI + i]) + (d11[GE + i] + (d12[IA + i] - d11[GE + i]) * d13[ddAMKI + i]) - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) * d13[dddKI + i]))) * El_boiler_eff
            - min((d11[FY + i] + (d12[HU + i] - d11[FY + i]) * d13[ddAMKI + i]), max(.zero, (d11[FK + i] + (d12[HG + i] - d11[FK + i]) * d13[ddAMKI + i]) - (d11[GG + i] + (d12[IC + i] - d11[GG + i]) * d13[ddAMKI + i])) / BESS_chrg_eff) - (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[dddKI + i]), 5))
    }
    ...
    for i in 0..<365 {
      d13[ddKM + i] = iff(
        d13[ddKI + i].isZero, .zero,
        round(
          (d11[FW + i] + (d12[HS + i] - d11[FW + i]) * d13[ddAMKI + i]) + (max(.zero, (d11[FT + i] + (d12[HP + i] - d11[FT + i]) * d13[ddAMKI + i]) + (d11[GF + i] + (d12[IB + i] - d11[GF + i]) * d13[ddAMKI + i]) - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) * d13[dddKI + i]))) * El_boiler_eff
            - min((d11[FZ + i] + (d12[HV + i] - d11[FZ + i]) * d13[ddAMKI + i]), max(.zero, (d11[FK + i] + (d12[HG + i] - d11[FK + i]) * d13[ddAMKI + i]) - (d11[GG + i] + (d12[IC + i] - d11[GG + i]) * d13[ddAMKI + i])) / BESS_chrg_eff) - (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[dddKI + i]), 5))
    }
    ...
    for i in 0..<365 { d13[ddKN + i] = iff(d13[ddKI + i].isZero, .zero, round((d11[GH + i] + (d12[ID + i] - d11[GH + i]) * d13[ddAMKI + i]) - max(.zero, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[dddKI + i]) - (d11[FV + i] + (d12[HR + i] - d11[FV + i]) * d13[ddAMKI + i])) / El_boiler_eff, 5)) }
    ...
    for i in 0..<365 { d13[ddKO + i] = iff(d13[ddKI + i].isZero, .zero, round((d11[GI + i] + (d12[IE + i] - d11[GI + i]) * d13[ddAMKI + i]) - max(.zero, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) * d13[dddKI + i]) - (d11[FW + i] + (d12[HS + i] - d11[FW + i]) * d13[ddAMKI + i])) / El_boiler_eff, 5)) }
      ...
      d13[ddKP + i] = iff(
        ...
        round(
          (d11[FY + i] + (d12[HU + i] - d11[FY + i]) / (d10[AM + i] - equiv_harmonious_min_perc[j]) * (d13[ddKI + i] - equiv_harmonious_min_perc[j])) - max(
            .zero, (d11[FK + i] + (d12[HG + i] - d11[FK + i]) / (d10[AM + i] - equiv_harmonious_min_perc[j]) * (d13[ddKI + i] - equiv_harmonious_min_perc[j])) - (d11[GG + i] + (d12[IC + i] - d11[GG + i]) / (d10[AM + i] - equiv_harmonious_min_perc[j]) * (d13[ddKI + i] - equiv_harmonious_min_perc[j]))) / BESS_chrg_eff, 5))
    }
    ...
    for i in 0..<365 {
      ...
      let x1 = d11[GE + i] + (d12[IA + i] - d11[GE + i]) * d13[ddAMKI + i]
      let x2 = d11[FV + i] + (d12[HR + i] - d11[FV + i]) * d13[ddAMKI + i]
      let x3 = min((d11[FY + i] + (d12[HU + i] - d11[FY + i]) * d13[ddAMKI + i]), max(.zero, (d11[FK + i] + (d12[HG + i] - d11[FK + i]) * d13[ddAMKI + i]) - (d11[GG + i] + (d12[IC + i] - d11[GG + i]) * d13[ddAMKI + i])) / BESS_chrg_eff)
      let x4 = d11[FS + i] + (d12[HO + i] - d11[FS + i]) * d13[ddAMKI + i]
      let x5 = d10[Z + i] + (d10[AA + i] - d10[Z + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j]) * (d13[ddKI + i] - equiv_harmonious_min_perc[j])

      let x00 = d10[AB + i] + (d10[AC + i] - d10[AB + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j]) * (d13[ddKI + i] - equiv_harmonious_min_perc[j])

      let x13 = (x4 - x5 - iff(x00 - x2 > 0, x00 - x2, 0) / El_boiler_eff - x3)

      d13[ddKR + i] = iff(d13[ddKI + i].isZero, .zero, round(x1 + iff(x13 < .zero, x13, .zero), 5))
    }
      ...
      d13[ddKS + i] = iff(
        ...
        round(
          (d11[GF + i] + (d12[IB + i] - d11[GF + i]) * d13[ddAMKI + i])
            - max(
              .zero,
              -((d11[FT + i] + (d12[HP + i] - d11[FT + i]) * d13[ddAMKI + i]) - (d10[Z + i] + (d10[AA + i] - d10[Z + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j]) * (d13[ddKI + i] - equiv_harmonious_min_perc[j])) - max(
                .zero, (d10[AB + i] + (d10[AC + i] - d10[AB + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j]) * (d13[ddKI + i] - equiv_harmonious_min_perc[j])) - (d11[FW + i] + (d12[HS + i] - d11[FW + i]) * d13[ddAMKI + i])) / El_boiler_eff
                - min((d11[FZ + i] + (d12[HV + i] - d11[FZ + i]) * d13[ddAMKI + i]), max(.zero, (d11[FK + i] + (d12[HG + i] - d11[FK + i]) * d13[ddAMKI + i]) - (d11[GG + i] + (d12[IC + i] - d11[GG + i]) * d13[ddAMKI + i])) / BESS_chrg_eff))), 5))
    }
    ...
    for i in 0..<365 { d13[ddKT + i] = iff(d13[ddKI + i].isZero, .zero, round((d11[GK + i] + (d12[IG + i] - d11[GK + i]) * d13[ddAMKI + i]) - (d10[AD + i] + (d10[AE + i] - d10[AD + i]) * d13[dddKI + i]), 5)) }
    ...
    for i in 0..<365 { d13[ddKU + i] = iff(d13[ddKI + i].isZero, .zero, round((d11[GL + i] + (d12[IH + i] - d11[GL + i]) * d13[ddAMKI + i]) - (d10[AD + i] + (d10[AE + i] - d10[AD + i]) * d13[dddKI + i]), 5)) }
    ...
    for i in 0..<365 { d13[ddKV + i] = iff(d13[ddKI + i].isZero, .zero, round((d11[GN + i] + (d12[IJ + i] - d11[GN + i]) * d13[ddAMKI + i]) - (d10[AF + i] + (d10[AG + i] - d10[AF + i]) * d13[dddKI + i]), 5)) }
    ...
    for i in 0..<365 { d13[ddKW + i] = iff(d13[ddKI + i].isZero, .zero, round((d11[GO + i] + (d12[IK + i] - d11[GO + i]) * d13[ddAMKI + i]) - (d10[AF + i] + (d10[AG + i] - d10[AF + i]) * d13[dddKI + i]), 5)) }
    ...
    for i in 0..<365 { d13[ddKX + i] = iff(d13[ddKI + i].isZero, .zero, round((d11[GQ + i] + (d12[IM + i] - d11[GQ + i]) * d13[ddAMKI + i]) - (d10[AH + i] + (d10[AI + i] - d10[AH + i]) * d13[dddKI + i]), 5)) }
    ...
    for i in 0..<365 { d13[ddKY + i] = iff(d13[ddKI + i].isZero, .zero, round((d11[GR + i] + (d12[IN + i] - d11[GR + i]) * d13[ddAMKI + i]) - (d10[AH + i] + (d10[AI + i] - d10[AH + i]) * d13[dddKI + i]), 5)) }
    ...
    for i in 0..<365 {
      d13[ddKZ + i] = iff(
        or(d13[ddKI + i].isZero, d13[ddKJ + i] < .zero, d13[ddKL + i] < .zero, d13[ddKN + i] < .zero, d13[ddKP + i] < .zero, d13[ddKR + i] < .zero, d13[ddKT + i] < .zero, d13[ddKV + i] < .zero, d13[ddKX + i] < .zero), 0,
        min(
