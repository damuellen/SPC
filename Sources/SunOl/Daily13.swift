extension TunOl {
  func d13(_ d13: inout [Double], case j: Int) {
    ...
    let (HO, HP, HR, HS, HU, HV, IA, IB, IC, ID, IE, IG, IH, IJ, IK, IM, IN) = (
      24455, 24820, 25550, 25915, 26645, 27010, 28835, 29200, 29565, 29930, 30295, 31025, 31390, 32120, 32485, 33215, 33580
    )  // d6
    let FK: Int = 16060
    let HG: Int = 21535
    let GA: Int = 21900
    ...
    for i in 0..<365 {
      d13[IQ + i] =
        d13[FS + i] + d13[GE + i] - d13[Z + i] - min(d13[GH + i], max(0, d13[AB + i] - d13[FV + i]) / El_boiler_eff) - min(
    ...
    for i in 0..<365 {
      d13[IR + i] =
        d13[HO + i] + d13[IA + i] - d13[AA + i] - min(d13[ID + i], max(0, d13[AC + i] - d13[HR + i]) / El_boiler_eff) - min(
    ...
    for i in 0..<365 {
      d13[IS + i] =
        d13[FT + i] + d13[GF + i] - d13[Z + i] - min(d13[GI + i], max(0, d13[AB + i] - d13[FW + i]) / El_boiler_eff) - min(
          BESS_cap_ud, max(0, d13[FK + i] - d13[GG + i] - d13[GA + i] * BESS_chrg_eff)) / BESS_chrg_eff
    }
    ...
    for i in 0..<365 {
      d13[IT + i] =
        d13[FV + i] + min(
          d13[GH + i], max(0, d13[FS + i] + d13[GE + i] - d13[Z + i] - min(BESS_cap_ud, max(0, d13[FK + i] - d13[GG + i] - d13[GA + i] * BESS_chrg_eff)) / BESS_chrg_eff))
    ...
    for i in 0..<365 {
      d13[IU + i] =
        d13[HR + i] + min(
          d13[ID + i], max(0, d13[HO + i] + d13[IA + i] - d13[AA + i] - min(BESS_cap_ud, max(0, d13[HG + i] - d13[IC + i] - d13[HW + i] * BESS_chrg_eff)) / BESS_chrg_eff))
    ...
    for i in 0..<365 {
      d13[IV + i] =
        d13[FW + i] + min(
          d13[GI + i], max(0, d13[FT + i] + d13[GF + i] - d13[Z + i] - min(BESS_cap_ud, max(0, d13[FK + i] - d13[GG + i] - d13[GA + i] * BESS_chrg_eff)) / BESS_chrg_eff))
        * El_boiler_eff - d13[AB + i]
    }
    /// Surplus el boiler cap after min harm op and min night op prep
    let IW: Int = 36865
    // =GH6-MAX(0,$AB6-FV6)/El_boiler_eff
    for i in 0..<365 { d13[IW + i] = d13[GH + i] - max(0.0, d13[AB + i] - d13[FV + i]) / El_boiler_eff }
    /// Surplus el boiler cap after min harm op and max night op prep
    let IX: Int = 37230
    // =ID6-MAX(0,$AC6-HR6)/El_boiler_eff
    for i in 0..<365 { d13[IX + i] = d13[ID + i] - max(0.0, d13[AC + i] - d13[HR + i]) / El_boiler_eff }
    /// Surplus el boiler cap after max harm op and min night op prep
    let IY: Int = 37595
    // =GI6-MAX(0,$AB6-FW6)/El_boiler_eff
    for i in 0..<365 { d13[IY + i] = d13[GI + i] - max(0.0, d13[AB + i] - d13[FW + i]) / El_boiler_eff }
    ...
    for i in 0..<365 {
      ...
      d13[IZ + i] = d13[FY + i] - min(BESS_cap_ud, max(0.0, d13[FK + i] - d13[GG + i] - d13[GA + i] * BESS_chrg_eff)) / BESS_chrg_eff
      // =HU6-MIN(BESS_cap_ud,MAX(0,HG6-IC6-HW6*BESS_chrg_eff))/BESS_chrg_eff
      d13[JA + i] = d13[HU + i] - min(BESS_cap_ud, max(0.0, d13[HG + i] - d13[IC + i] - d13[HW + i] * BESS_chrg_eff)) / BESS_chrg_eff
      // =FZ6-MIN(BESS_cap_ud,MAX(0,FK6-GG6-GA6*BESS_chrg_eff))/BESS_chrg_eff
      d13[JB + i] = d13[FZ + i] - min(BESS_cap_ud, max(0.0, d13[FK + i] - d13[GG + i] - d13[GA + i] * BESS_chrg_eff)) / BESS_chrg_eff
    }
      ...
      d13[JC + i] =
        ...
        - max(
          ...
          -(d13[FS + i] - d13[Z + i] - min(d13[GH + i], max(0, d13[AB + i] - d13[FV + i]) / El_boiler_eff) - min(
            BESS_cap_ud, max(0.0, d13[FK + i] - d13[GG + i] - d13[GA + i] * BESS_chrg_eff)) / BESS_chrg_eff))
    }
    ...
    for i in 0..<365 {
      d13[JP + i] = iff(
        or(d13[AM + i].isZero, d13[IQ + i] < 0, d13[IT + i] < 0, d13[IW + i] < 0, d13[IZ + i] < 0, d13[JC + i] < 0, d13[JF + i] < 0, d13[JI + i] < 0, d13[JL + i] < 0), 0,
        min(
      ...
      d13[JQ + i] = iff(
        ...
        round(
          (d13[FS + i] + (d13[FT + i] - d13[FS + i]) * d13[dJP + i]) + (d13[GE + i] + (d13[GF + i] - d13[GE + i]) * d13[dJP + i]) - d13[Z + i]
            - min((d13[GH + i] + (d13[GI + i] - d13[GH + i]) * d13[dJP + i]), max(0.0, d13[AB + i] - (d13[FV + i] + (d13[FW + i] - d13[FV + i]) * d13[dJP + i])) / El_boiler_eff)
            - min(BESS_cap_ud, max(0, d13[FK + i] - d13[GG + i] - d13[GA + i] * BESS_chrg_eff)) / BESS_chrg_eff, 5))
    }
          ...
          (d13[HO + i] + (d13[HP + i] - d13[HO + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc) * (d13[JP + i] - Overall_harmonious_min_perc))
            ...
            - min(
              ...
              max(
                ...
                / El_boiler_eff) - min(BESS_cap_ud, max(0, d13[HG + i] - d13[IC + i] - d13[HW + i] * BESS_chrg_eff)) / BESS_chrg_eff, 5))
    }
      ...
      d13[JS + i] = iff(
        ...
        round(
          (d13[FV + i] + (d13[FW + i] - d13[FV + i]) * d13[dJP + i]) + min(
            ...
            max(0.0, (d13[FS + i] + (d13[FT + i] - d13[FS + i]) * d13[dJP + i]) + (d13[GE + i] + (d13[GF + i] - d13[GE + i]) * d13[dJP + i]) - d13[Z + i]) * El_boiler_eff
              - min(
                (d13[FY + i] + (d13[FZ + i] - d13[FY + i]) * d13[dJP + i]), min(BESS_cap_ud, max(0.0, d13[FK + i] - d13[GG + i] - d13[GA + i] * BESS_chrg_eff)) / BESS_chrg_eff))
          ...
          (d13[HR + i] + (d13[HS + i] - d13[HR + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc) * (d13[JP + i] - Overall_harmonious_min_perc)) + min(
            ...
            max(
              ...
              (d13[HO + i] + (d13[HP + i] - d13[HO + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc) * (d13[JP + i] - Overall_harmonious_min_perc))
                ...
                - d13[AA + i] - min(BESS_cap_ud, max(0, d13[HG + i] - d13[IC + i] - d13[HW + i] * BESS_chrg_eff)) / BESS_chrg_eff)) * El_boiler_eff - d13[AC + i], 5))
    }
    ...
    for i in 0..<365 {
      d13[JU + i] = iff(
        d13[JP + i].isZero, 0.0,
        round((d13[GH + i] + (d13[GI + i] - d13[GH + i]) * d13[dJP + i]) - max(0.0, d13[AB + i] - (d13[FV + i] + (d13[FW + i] - d13[FV + i]) * d13[dJP + i])) / El_boiler_eff, 5))
    }
    ...
    for i in 0..<365 {
      d13[JW + i] = iff(
        d13[JP + i].isZero, 0.0,
        round(
          (d13[FY + i] + (d13[FZ + i] - d13[FY + i]) * d13[dJP + i]) - min(El_boiler_cap_ud, max(0.0, d13[FK + i] - d13[GG + i] - d13[GA + i] * BESS_chrg_eff)) / BESS_chrg_eff, 5)
      )
    }
    ...
    for i in 0..<365 {
      d13[JX + i] = iff(
        d13[JP + i].isZero, 0.0,
        round(
          (d13[HU + i] + (d13[HV + i] - d13[HU + i]) * d13[dJP + i]) - min(El_boiler_cap_ud, max(0.0, d13[HG + i] - d13[IC + i] - d13[HW + i] * BESS_chrg_eff)) / BESS_chrg_eff, 5)
      )
    }
    ...
    for i in 0..<365 { d13[KE + i] = iff(d13[JP + i].isZero, 0.0, round((d13[GQ + i] + (d13[GR + i] - d13[GQ + i]) * d13[dJP + i]) - d13[AH + i], 5)) }
    ...
    for i in 0..<365 { d13[KF + i] = iff(d13[JP + i].isZero, 0.0, round(d13[IM + i] + (d13[IN + i] - d13[IM + i]) * d13[dJP + i] - d13[AI + i], 5)) }
    ...
    for i in 0..<365 {
      d13[KG + i] = iff(
        or(
          d13[AM + i].isZero, d13[JP + i].isZero, d13[JQ + i] < 0, d13[JS + i] < 0, d13[JU + i] < 0, d13[JW + i] < 0, d13[JY + i] < 0, d13[KA + i] < 0, d13[KC + i] < 0,
          d13[KE + i] < 0), 0,
        min(
    ...
    let AMKG = 59130  // let LF = 59130
    let AMKI = 74825  // let MW = 74825
    for i in 0..<365 {
        ...
        round(
          (d13[FS + i] + (d13[HO + i] - d13[FS + i]) * d13[AMKI + i]) + (d13[GE + i] + (d13[IA + i] - d13[GE + i]) * d13[AMKI + i])
            ...
            - min(
              ...
              max(0.0, (d13[AB + i] + (d13[AC + i] - d13[AB + i]) * d13[AMKI + i]) - (d13[FV + i] + (d13[HR + i] - d13[FV + i]) * d13[AMKI + i])) / El_boiler_eff) - min(
              BESS_cap_ud,
              max(
                0.0,
      ...
      d13[KK + i] = iff(
        ...
        round(
          (d13[FT + i] + (d13[HP + i] - d13[FT + i]) * d13[AMKI + i]) + (d13[GF + i] + (d13[IB + i] - d13[GF + i]) * d13[AMKI + i])
            ...
            - min(
              (d13[GH + i] + (d13[ID + i] - d13[GH + i]) * d13[AMKI + i]),
              max(0.0, (d13[AB + i] + (d13[AC + i] - d13[AB + i]) * d13[AMKI + i]) - (d13[FW + i] + (d13[HS + i] - d13[FW + i]) * d13[AMKI + i])) / El_boiler_eff) - min(
              BESS_cap_ud,
              max(
                0.0,
                (d13[FK + i] + (d13[HG + i] - d13[FK + i]) * d13[AMKI + i]) - (d13[GG + i] + (d13[IC + i] - d13[GG + i]) * d13[AMKI + i])
        ...
        round(
          (d13[FV + i] + (d13[HR + i] - d13[FV + i]) * d13[AMKI + i])
            ...
            - min(
              ...
              min(BESS_cap_ud, max(0.0, (d13[FK + i] + (d13[HG + i] - d13[FK + i]) * d13[AMKI + i]) - (d13[GG + i] + (d13[IC + i] - d13[GG + i]) * d13[AMKI + i])) / BESS_chrg_eff)
            ...
            + min(
              ...
              (max(
                ...
                - min(
                  ...
                  min(BESS_cap_ud, max(0.0, (d13[FK + i] + (d13[HG + i] - d13[FK + i]) * d13[AMKI + i]) - (d13[GG + i] + (d13[IC + i] - d13[GG + i]) * d13[AMKI + i])))
      ...
      d13[KN + i] = iff(
        ...
        round(
          (d13[GH + i] + (d13[ID + i] - d13[GH + i]) * d13[AMKI + i]) - max(
            0.0, (d13[AB + i] + (d13[AC + i] - d13[AB + i]) * d13[AMKI + i]) - (d13[FV + i] + (d13[HR + i] - d13[FV + i]) * d13[AMKI + i])) / El_boiler_eff, 5))
    }
      ...
      d13[KO + i] = iff(
        ...
        round(
          (d13[GI + i] + (d13[IE + i] - d13[GI + i]) * d13[AMKI + i]) - max(
            0.0, (d13[AB + i] + (d13[AC + i] - d13[AB + i]) * d13[AMKI + i]) - (d13[FW + i] + (d13[HS + i] - d13[FW + i]) * d13[AMKI + i])) / El_boiler_eff, 5))
    }
    ...
    for i in 0..<365 {
      d13[KT + i] = iff(
        d13[KI + i].isZero, 0.0, round((d13[GK + i] + (d13[IG + i] - d13[GK + i]) * d13[AMKI + i]) - (d13[AD + i] + (d13[AE + i] - d13[AD + i]) * d13[AMKI + i]), 5))
    }
    ...
    for i in 0..<365 {
      d13[KU + i] = iff(
        d13[KI + i].isZero, 0.0, round((d13[GL + i] + (d13[IH + i] - d13[GL + i]) * d13[AMKI + i]) - (d13[AD + i] + (d13[AE + i] - d13[AD + i]) * d13[AMKI + i]), 5))
    }
    ...
    for i in 0..<365 {
      d13[KV + i] = iff(
        d13[KI + i].isZero, 0.0, round((d13[GN + i] + (d13[IJ + i] - d13[GN + i]) * d13[AMKI + i]) - (d13[AF + i] + (d13[AG + i] - d13[AF + i]) * d13[AMKI + i]), 5))
    }
    ...
    for i in 0..<365 {
      d13[KW + i] = iff(
        d13[KI + i].isZero, 0.0, round((d13[GO + i] + (d13[IK + i] - d13[GO + i]) * d13[AMKI + i]) - (d13[AF + i] + (d13[AG + i] - d13[AF + i]) * d13[AMKI + i]), 5))
    }
    ...
    for i in 0..<365 {
      d13[KX + i] = iff(
        d13[KI + i].isZero, 0.0, round((d13[GQ + i] + (d13[IM + i] - d13[GQ + i]) * d13[AMKI + i]) - (d13[AH + i] + (d13[AI + i] - d13[AH + i]) * d13[AMKI + i]), 5))
    }
    ...
    for i in 0..<365 {
      d13[KY + i] = iff(
        d13[KI + i].isZero, 0.0, round((d13[GR + i] + (d13[IN + i] - d13[GR + i]) * d13[AMKI + i]) - (d13[AH + i] + (d13[AI + i] - d13[AH + i]) * d13[AMKI + i]), 5))
    }
