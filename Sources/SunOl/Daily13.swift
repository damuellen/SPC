...
extension TunOl {
  mutating func day(case j: Int, day1: [Double], day5: [Double], day6: [Double]) -> [Double] {
    ...
    var day7 = [Double](repeating: 0, count: 44_165)
    ...
    for i in 0..<365 {
      day7[dayIQ + i] =
        day5[dayFS + i] + day5[dayGE + i] - day1[dayZ + i] - max(
          0, day1[dayAB + i] - day5[dayFV + i]) / El_boiler_eff - day5[dayFR + i] / BESS_chrg_eff
    }
        ...
        - max(
          ...
          (day1[dayAB + i]
            + (day1[dayAC + i] - day1[dayAB + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
              * (day1[dayAM + i] - equiv_harmonious_min_perc[j]))
            - day1[dayHR + i]) / El_boiler_eff - day1[dayHN + i] / BESS_chrg_eff
    }
    ...
    for i in 0..<365 {
      day7[dayIS + i] =
        day5[dayFT + i] + day5[dayGF + i] - day1[dayZ + i] - max(
          0, day1[dayAB + i] - day5[dayFW + i]) / El_boiler_eff - day5[dayFR + i] / BESS_chrg_eff
    }
    ...
    for i in 0..<365 {
      day7[dayIT + i] =
        day5[dayFV + i] + max(
          0, day5[dayFS + i] + day5[dayGE + i] - day1[dayZ + i] - day5[dayFR + i] / BESS_chrg_eff)
        ...
        day1[dayHR + i] + max(
          ...
          day1[dayHO + i] + day6[dayIA + i]
            - (day1[dayZ + i]
              + (day1[dayAA + i] - day1[dayZ + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayAM + i] - equiv_harmonious_min_perc[j]))
            - day1[dayHN + i] / BESS_chrg_eff) * El_boiler_eff
        - (day1[dayAB + i]
          + (day1[dayAC + i] - day1[dayAB + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
            * (day1[dayAM + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    for i in 0..<365 {
      day7[dayIV + i] =
        day5[dayFW + i] + max(
          0, day5[dayFT + i] + day5[dayGF + i] - day1[dayZ + i] - day5[dayFR + i] / BESS_chrg_eff)
        * El_boiler_eff - day1[dayAB + i]
    }
    ...
    for i in 0..<365 {
      day7[dayIW + i] = day1[dayGH + i] - (day1[dayAB + i] - day5[dayFV + i]) / El_boiler_eff
    }
    ...
    for i in 0..<365 {
      day7[dayIY + i] = day5[dayGI + i] - (day1[dayAB + i] - day5[dayFW + i]) / El_boiler_eff
    }

    /// Surplus BESS chrg cap after min harm op and min night op prep
    let dayIZ = 3285
    // FY6-FR6/BESS_chrg_eff
    for i in 0..<365 { day7[dayIZ + i] = day5[dayFY + i] - day5[dayFR + i] / BESS_chrg_eff }

    /// Surplus BESS chrg cap after min harm op and max night op prep
    let dayJA = 3650
    // HU6-HN6/BESS_chrg_eff
    for i in 0..<365 { day7[dayJA + i] = day6[dayHU + i] - day1[dayHN + i] / BESS_chrg_eff }

    /// Surplus BESS chrg cap after max harm op and min night op prep
    let dayJB = 4015
    // FZ6-FR6/BESS_chrg_eff
    for i in 0..<365 { day7[dayJB + i] = day5[dayFZ + i] - day5[dayFR + i] / BESS_chrg_eff }

    /// Surplus RawMeth prod cap after min harm op and min night op prep
    let dayJC = 4380
    // GK6-AD6
    for i in 0..<365 { day7[dayJC + i] = day5[dayGK + i] - day1[dayAD + i] }
    ...
    for i in 0..<365 {
      day7[dayJD + i] =
        day6[dayIG + i]
        - (day1[dayAD + i]
          + (day1[dayAE + i] - day1[dayAD + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
            * (day1[dayAM + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    let dayJE = 5110
    // GL6-AD6
    for i in 0..<365 { day7[dayJE + i] = day1[dayGL + i] - day1[dayAD + i] }
    ...
    for i in 0..<365 {
      day7[dayJG + i] =
        day6[dayIJ + i]
        - (day1[dayAF + i]
          + (day1[dayAG + i] - day1[dayAF + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
            * (day1[dayAM + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    for i in 0..<365 {
      day7[dayJJ + i] =
        day6[dayIM + i]
        - (day1[dayAH + i]
          + (day1[dayAI + i] - day1[dayAH + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
            * (day1[dayAM + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    let dayJK = 7300
    // GR6-AH6
    for i in 0..<365 { day7[dayJK + i] = day1[dayGR + i] - day1[dayAH + i] }
    ...
    for i in 0..<365 {
      day7[dayJM + i] = iff(
        or(
          day1[dayIQ + i] < 0, day7[dayIT + i] < 0, day7[dayIW + i] < 0, day7[dayIZ + i] < 0,
          day1[dayJC + i] < 0, day1[dayJF + i] < 0, day1[dayJI + i] < 0), 0,
        min(
          1, ifFinite(day1[dayIQ + i] / (day1[dayIQ + i] - day7[dayIS + i]), 1),
          ifFinite(day7[dayIT + i] / (day7[dayIT + i] - day7[dayIV + i]), 1),
          ifFinite(day7[dayIW + i] / (day7[dayIW + i] - day7[dayIY + i]), 1),
          ifFinite(day7[dayIZ + i] / (day7[dayIZ + i] - day1[dayJB + i]), 1),
          ifFinite(day1[dayJC + i] / (day1[dayJC + i] - day1[dayJE + i]), 1),
          ifFinite(day1[dayJF + i] / (day1[dayJF + i] - day1[dayJH + i]), 1),
          ifFinite(day1[dayJI + i] / (day1[dayJI + i] - day1[dayJK + i]), 1))
    ...
    for i in 0..<365 {
      day7[dayJO + i] = iff(
        ...
        round(
          (day1[dayHO + i]
            + (day1[dayHP + i] - day1[dayHO + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
              * (day1[dayJM + i] - Overall_harmonious_min_perc))
            + (day6[dayIA + i]
            ...
            - max(
              ...
              (day1[dayAB + i]
                + (day1[dayAC + i] - day1[dayAB + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                  * (day1[dayAM + i] - equiv_harmonious_min_perc[j]))
                - (day1[dayHR + i]
                  + (day7[dayHS + i] - day1[dayHR + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
                    * (day1[dayJM + i] - Overall_harmonious_min_perc))
            ) / El_boiler_eff - day1[dayHN + i] / BESS_chrg_eff, 5))
    }
    ...
    for i in 0..<365 {
      day7[dayJR + i] = iff(
        ...
        round(
          (day1[dayGH + i]
            + (day5[dayGI + i] - day1[dayGH + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
              * (day1[dayJM + i] - Overall_harmonious_min_perc))
            - (day1[dayAB + i]
              - (day5[dayFV + i]
                + (day5[dayFW + i] - day5[dayFV + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
    ...
    for i in 0..<365 {
      day7[dayJS + i] = iff(
        ...
        round(
          (day6[dayID + i]
            + (day6[dayIE + i] - day6[dayID + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
              * (day1[dayJM + i] - Overall_harmonious_min_perc))
            - ((day1[dayAB + i]
              + (day1[dayAC + i] - day1[dayAB + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayAM + i] - equiv_harmonious_min_perc[j]))
    ...
    for i in 0..<365 {
      day7[dayJT + i] = iff(
        ...
        round(
          (day5[dayFY + i]
            + (day5[dayFZ + i] - day5[dayFY + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
              * (day1[dayJM + i] - Overall_harmonious_min_perc))
    ...
    for i in 0..<365 {
      day7[dayJU + i] = iff(
        ...
        round(
          (day6[dayHU + i]
            + (day1[dayHV + i] - day6[dayHU + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
              * (day1[dayJM + i] - Overall_harmonious_min_perc))
            - day1[dayHN + i] / BESS_chrg_eff, 5))
    }
    ...
    for i in 0..<365 {
      day7[dayJV + i] = iff(
        ...
        round(
          (day5[dayGK + i]
            + (day1[dayGL + i] - day5[dayGK + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
              * (day1[dayJM + i] - Overall_harmonious_min_perc))
            - day1[dayAD + i], 5))
    }
    ...
    for i in 0..<365 {
      day7[dayJW + i] = iff(
        day1[dayJM + i].isZero, 0,
        round(
          day5[dayGK + i] + (day1[dayGL + i] - day5[dayGK + i])
            / (Overall_harmonious_max_perc - Overall_harmonious_min_perc) * (day1[dayJM + i] - Overall_harmonious_min_perc)
            - (day1[dayAD + i]
              + (day1[dayAE + i] - day1[dayAD + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayAM + i] - equiv_harmonious_min_perc[j])),
          5))
    ...
    for i in 0..<365 {
      day7[dayJX + i] = iff(
        ...
        round(
          (day5[dayGN + i]
            + (day5[dayGO + i] - day5[dayGN + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
              * (day1[dayJM + i] - Overall_harmonious_min_perc))
            - day1[dayAF + i], 5))
    }
    ...
    for i in 0..<365 {
      day7[dayJZ + i] = iff(
        day7[dayJM + i].isZero, 0,
        round(
          (day1[dayGQ + i]
            + (day1[dayGR + i] - day1[dayGQ + i]) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
    ...
    for i in 0..<365 {
      day7[dayKA + i] = iff(
        day7[dayJM + i].isZero, 0,
        round(
          day1[dayGQ + i] + (day1[dayGR + i] - day1[dayGQ + i])
            / (Overall_harmonious_max_perc - Overall_harmonious_min_perc) * (day7[dayJM + i] - Overall_harmonious_min_perc)
            - (day1[dayAH + i]
              + (day1[dayAI + i] - day1[dayAH + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayAM + i] - equiv_harmonious_min_perc[j])),
          5))
    ...
    for i in 0..<365 {
      day7[dayKB + i] = iff(
        or(
          day7[dayJM + i].isZero, day1[dayJN + i] < 0, day1[dayJP + i] < 0, day7[dayJR + i] < 0,
          day1[dayJT + i] < 0, day7[dayJV + i] < 0, day1[dayJX + i] < 0, day7[dayJZ + i] < 0), 0,
        min(
          1, ifFinite(day1[dayJN + i] / (day1[dayJN + i] - day7[dayJO + i]), 1),
          ifFinite(day1[dayJP + i] / (day1[dayJP + i] - day1[dayJQ + i]), 1),
          ifFinite(day7[dayJR + i] / (day7[dayJR + i] - day1[dayJS + i]), 1),
          ifFinite(day1[dayJT + i] / (day1[dayJT + i] - day1[dayJU + i]), 1),
          ifFinite(day7[dayJV + i] / (day7[dayJV + i] - day1[dayJW + i]), 1),
          ifFinite(day1[dayJX + i] / (day1[dayJX + i] - day1[dayJY + i]), 1),
          ifFinite(day7[dayJZ + i] / (day7[dayJZ + i] - day1[dayKA + i]), 1))
    ...
    for i in 0..<365 {
      day7[dayKD + i] = iff(
        or(
          day1[dayIQ + i] < 0, day1[dayIT + i] < 0, day7[dayIW + i] < 0, day1[dayIZ + i] < 0,
          day1[dayJC + i] < 0, day1[dayJF + i] < 0, day1[dayJI + i] < 0), 0,
        min(
          1, ifFinite(day1[dayIQ + i] / (day1[dayIQ + i] - day1[dayIR + i]), 1),
          ifFinite(day1[dayIT + i] / (day1[dayIT + i] - day1[dayIU + i]), 1),
          ifFinite(day7[dayIW + i] / (day7[dayIW + i] - day1[dayIX + i]), 1),
          ifFinite(day1[dayIZ + i] / (day1[dayIZ + i] - day1[dayJA + i]), 1),
          ifFinite(day1[dayJC + i] / (day1[dayJC + i] - day1[dayJD + i]), 1),
          ifFinite(day1[dayJF + i] / (day1[dayJF + i] - day7[dayJG + i]), 1),
          ifFinite(day1[dayJI + i] / (day1[dayJI + i] - day7[dayJJ + i]), 1))
          * (day1[dayAM + i] - equiv_harmonious_min_perc[j]) + equiv_harmonious_min_perc[j])
    }
    ...
    for i in 0..<365 {
      day7[dayKE + i] = iff(
        day1[dayKD + i].isZero, 0,
        round(
          (day5[dayFS + i]
            + (day6[dayHO + i] - day5[dayFS + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            + (day5[dayGE + i]
              + (day1[dayIA + i] - day5[dayGE + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            - (day1[dayZ + i]
              + (day1[dayAA + i] - day1[dayZ + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
        ...
        round(
          (day5[dayFT + i]
            + (day6[dayHP + i] - day5[dayFT + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            + (day5[dayGF + i]
              + (day1[dayIB + i] - day5[dayGF + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            - (day1[dayZ + i]
              + (day1[dayAA + i] - day1[dayZ + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
    ...
    for i in 0..<365 {
      day7[dayKI + i] = iff(
        ...
        round(
          (day1[dayGH + i]
            + (day1[dayID + i] - day1[dayGH + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            - ((day1[dayAB + i]
              + (day1[dayAC + i] - day1[dayAB + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
    ...
    for i in 0..<365 {
      day7[dayKJ + i] = iff(
        ...
        round(
          (day5[dayGI + i]
            + (day1[dayIE + i] - day5[dayGI + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            - ((day1[dayAB + i]
              + (day1[dayAC + i] - day1[dayAB + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
    ...
    for i in 0..<365 {
      day7[dayKM + i] = iff(
        ...
        round(
          (day1[dayGK + i]
            + (day1[dayIG + i] - day1[dayGK + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            - (day1[dayAD + i]
              + (day1[dayAE + i] - day1[dayAD + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j])),
    ...
    for i in 0..<365 {
      day7[dayKN + i] = iff(
        ...
        round(
          (day5[dayGL + i]
            + (day1[dayIH + i] - day5[dayGL + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            - (day1[dayAD + i]
              + (day1[dayAE + i] - day1[dayAD + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j])),
    ...
    for i in 0..<365 {
      day7[dayKO + i] = iff(
        ...
        round(
          (day5[dayGN + i]
            + (day1[dayIJ + i] - day5[dayGN + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            - (day1[dayAF + i]
              + (day1[dayAG + i] - day1[dayAF + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j])),
    ...
    for i in 0..<365 {
      day7[dayKP + i] = iff(
        ...
        round(
          (day5[dayGO + i]
            + (day1[dayIK + i] - day5[dayGO + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            - (day1[dayAF + i]
              + (day1[dayAG + i] - day1[dayAF + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j])),
    ...
    for i in 0..<365 {
      day7[dayKQ + i] = iff(
        ...
        round(
          (day1[dayGQ + i]
            + (day1[dayIM + i] - day1[dayGQ + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            - (day1[dayAH + i]
              + (day1[dayAI + i] - day1[dayAH + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j])),
    ...
    for i in 0..<365 {
      day7[dayKR + i] = iff(
        ...
        round(
          (day1[dayGR + i]
            + (day1[dayIN + i] - day1[dayGR + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            - (day1[dayAH + i]
              + (day1[dayAI + i] - day1[dayAH + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j])),
    ...
    for i in 0..<365 {
      day7[dayKS + i] = iff(
        day1[dayKD + i] <= 0, 0,
        min(
          1, ifFinite(day1[dayKE + i] / (day1[dayKE + i] - day1[dayKF + i]), 1),
          ifFinite(day7[dayKG + i] / (day7[dayKG + i] - day1[dayKH + i]), 1),
          ifFinite(day1[dayKI + i] / (day1[dayKI + i] - day1[dayKJ + i]), 1),
          ifFinite(day1[dayKK + i] / (day1[dayKK + i] - day1[dayKL + i]), 1),
          ifFinite(day7[dayKM + i] / (day7[dayKM + i] - day1[dayKN + i]), 1),
          ifFinite(day1[dayKO + i] / (day1[dayKO + i] - day1[dayKP + i]), 1),
          ifFinite(day1[dayKQ + i] / (day1[dayKQ + i] - day1[dayKR + i]), 1))
          * (Overall_harmonious_max_perc - Overall_harmonious_min_perc) + Overall_harmonious_min_perc)
    }
    ...
    for i in 0..<365 {
      day7[dayKU + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0,
        (day5[dayFC + i]
          + (day6[dayGY + i] - day5[dayFC + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
            * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
          + ((day5[dayFD + i]
            + (day1[dayGZ + i] - day5[dayFD + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
            - (day5[dayFC + i]
              + (day6[dayGY + i] - day5[dayFC + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
                * (day1[dayKB + i] - equiv_harmonious_min_perc[j])))
    ...
    for i in 0..<365 {
      day7[dayKW + i] = iff(
        ...
        day5[dayFO + i] + (day6[dayHK + i] - day5[dayFO + i])
          / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    let dayKZ = 21170
    // LH6/El_boiler_eff
    // for i in 0..<365 { day7[dayKZ + i] = day1[dayLH + i] / El_boiler_eff }
    ...
    for i in 0..<365 {
      day7[dayLA + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0,
        day1[dayEY + i] + (day6[dayGU + i] - day1[dayEY + i])
          / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
    }
      ...
      day7[dayLB + i] = iff(
        ...
        (day5[dayFI + i]
          + (day6[dayHE + i] - day5[dayFI + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
            * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
          + ((day5[dayFJ + i]
            + (day1[dayHF + i] - day5[dayFJ + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
            - (day5[dayFI + i]
              + (day6[dayHE + i] - day5[dayFI + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
                * (day1[dayKB + i] - equiv_harmonious_min_perc[j])))
    ...
    for i in 0..<365 {
      day7[dayLC + i] = iff(
      or(
     day7[dayJM + i].isZero,day1[dayKB + i].isZero),0, min((day5[dayGE + i] + (day1[dayIA + i] - day5[dayGE + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j])) + ((day5[dayGF + i] + (day1[dayIB + i] - day5[dayGF + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j])) - (day5[dayGE + i] + (day1[dayIA + i] - day5[dayGE + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc) * (day7[dayJM + i] - Overall_harmonious_min_perc),max(0, -(day1[dayLA + i] + day1[dayLB + i] - day1[dayKU + i] - day1[dayKV + i] - day1[dayKW + i] - day7[dayKX + i] - day7[dayKY + i] - day1[dayKZ + i]))))
    }
    ...
    for i in 0..<365 {
      day7[dayLD + i] =
        day1[dayLA + i] + day1[dayLB + i] + day1[dayLC + i] - day1[dayKU + i] - day1[dayKV + i]
        - day1[dayKW + i] - day7[dayKX + i] - day7[dayKY + i] - day1[dayKZ + i]
    }
      ...
      day7[dayLE + i] = iff(
        ...
        (day5[dayFF + i]
          + (day6[dayHB + i] - day5[dayFF + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
            * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
          + ((day5[dayFG + i]
            + (day1[dayHC + i] - day5[dayFG + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
            - (day5[dayFF + i]
              + (day6[dayHB + i] - day5[dayFF + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
                * (day1[dayKB + i] - equiv_harmonious_min_perc[j])))
    ...
    for i in 0..<365 {
      day7[dayLG + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0, day7[dayKY + i] * El_boiler_eff)
    }
    ...
    for i in 0..<365 {
      day7[dayLI + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0,
        day1[dayFA + i] + (day1[dayGW + i] - day1[dayFA + i])
          / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    for i in 0..<365 {
      day7[dayLJ + i] =
        day1[dayLG + i] + day1[dayLH + i] + day1[dayLI + i] - day1[dayLE + i] - day1[dayLF + i]
    }
    ...
    for i in 0..<365 {
      day7[dayLK + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0,
        day5[dayFE + i] + (day1[dayHA + i] - day5[dayFE + i])
          / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    for i in 0..<365 {
      day7[dayLL + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0,
        day5[dayFP + i] + (day1[dayHL + i] - day5[dayFP + i])
          / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    for i in 0..<365 {
      day7[dayLM + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0,
        day5[dayFN + i] + (day1[dayHJ + i] - day5[dayFN + i])
          / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    for i in 0..<365 {
      day7[dayLO + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0,
        day1[dayEZ + i] + (day1[dayGV + i] - day1[dayEZ + i])
          / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    for i in 0..<365 {
      day7[dayLP + i] = iff(
      or(
     day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0, min(day5[dayGG + i] + (day1[dayIC + i] - day5[dayGG + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]),max(0, -(day7[dayLN + i] + day1[dayLO + i] - day1[dayLK + i] - day1[dayLL + i] - day1[dayLM + i]))))
    }
    ...
    for i in 0..<365 {
      day7[dayLQ + i] =
        day7[dayLN + i] + day1[dayLO + i] + day1[dayLP + i] - day1[dayLK + i] - day1[dayLL + i]
        - day1[dayLM + i]
    }
    ...
    for i in 0..<365 {
      day7[dayLR + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0,
        day5[dayFH + i] + (day1[dayHD + i] - day5[dayFH + i])
          / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    for i in 0..<365 {
      day7[dayLS + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0, day1[dayLM + i] * El_boiler_eff)
    }
    ...
    for i in 0..<365 {
      day7[dayLT + i] = iff(
        or(day7[dayJM + i].isZero, day1[dayKB + i].isZero), 0,
        day5[dayFB + i] + (day1[dayGX + i] - day5[dayFB + i])
          / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
    }
    ...
    let dayLU = 28835
    // LS6+LT6-LR6
    for i in 0..<365 { day7[dayLU + i] = day7[dayLS + i] + day1[dayLT + i] - day1[dayLR + i] }
    ...
    for i in 0..<365 {
      day7[dayLV + i] =
        iff(
          day1[dayKU + i] <= 0, 0,
          day1[dayKU + i] / (Overall_harmonious_var_max_cons + Overall_fix_cons) * MethDist_harmonious_max_perc
            * MethDist_Meth_nom_prod_ud)
        + iff(
          day1[dayLK + i] <= 0, 0,
          (day1[dayLK + i] - overall_stup_cons[j]) / (overall_var_max_cons[j] + overall_fix_stby_cons[j])
          ...
          iff(
            ...
            (day1[dayGB + i]
              + (day6[dayHX + i] - day1[dayGB + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
                * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
              + ((day1[dayGC + i]
                + (day1[dayHY + i] - day1[dayGC + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
                  * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
                - (day1[dayGB + i]
                  + (day6[dayHX + i] - day1[dayGB + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
                    * (day1[dayKB + i] - equiv_harmonious_min_perc[j])))
    ...
    let dayLX = 29930
    // LP6+LC6
    for i in 0..<365 { day7[dayLX + i] = day1[dayLP + i] + day1[dayLC + i] }
    ...
    for i in 0..<365 {
      day7[dayLY + i] = iff(
        day1[dayKB + i] <= 0, 0,
        (day1[dayC + i]
          + (day1[dayT + i] - day1[dayC + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
            * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
      )
    }
    ...
    for i in 0..<365 {
      day7[dayLZ + i] = iff(
        day1[dayKB + i] <= 0, 0,
        (day1[dayD + i]
          + (day1[dayU + i] - day1[dayD + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
            * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
      )
    }
    ...
    for i in 0..<365 {
      day7[dayMA + i] = iff(
        day1[dayKB + i] <= 0, 0,
        (day1[dayE + i]
          + (day1[dayV + i] - day1[dayE + i]) / (equiv_harmonious_max_perc[j] - equiv_harmonious_min_perc[j])
            * (day1[dayKB + i] - equiv_harmonious_min_perc[j]))
      )
    }
    ...
    for i in 0..<365 {
      day7[dayMB + i] =
        max(0, -day1[dayLD + i]) + max(0, -day1[dayLJ + i]) + max(0, -day7[dayLQ + i])
        + max(0, -day1[dayLU + i])
    }
    ...
    for i in 0..<365 {
      day7[dayMD + i] = iff(
        or(day1[dayKS + i].isZero, day1[dayKD + i].isZero), 0,
        (day5[dayFC + i]
          + (day6[dayGY + i] - day5[dayFC + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
            * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
          + ((day5[dayFD + i]
            ...
            - (day5[dayFC + i]
              + (day6[dayGY + i] - day5[dayFC + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
                * (day1[dayKD + i] - equiv_harmonious_min_perc[j])))
          / (Overall_harmonious_max_perc - Overall_harmonious_min_perc) * (day1[dayKS + i] - Overall_harmonious_min_perc))
    }
    ...
    for i in 0..<365 {
      day7[dayMF + i] = iff(
        or(day1[dayKS + i].isZero, day1[dayKD + i].isZero), 0,
        day5[dayFO + i] + (day6[dayHK + i] - day5[dayFO + i])
          / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
    }
            ...
            + ((day5[dayFZ + i]
              ...
              - (day5[dayFY + i]
                + (day6[dayHU + i] - day5[dayFY + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
                  * (day1[dayKD + i] - equiv_harmonious_min_perc[j])))
              / (Overall_harmonious_max_perc - Overall_harmonious_min_perc)
              * (day1[dayKS + i] - Overall_harmonious_min_perc)),
          (day5[dayFR + i]
            + (day6[dayHN + i] - day5[dayFR + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
              * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
            / BESS_chrg_eff))
    ...
    let dayMI = 33580
    // MQ6/El_boiler_eff
    // for i in 0..<365 { day7[dayMI + i] = day1[dayMQ + i] / El_boiler_eff }
    ...
    for i in 0..<365 {
      day7[dayMK + i] = iff(
        or(day1[dayKD + i].isZero, day1[dayKS + i].isZero), 0,
        (day5[dayFI + i]
          + (day6[dayHE + i] - day5[dayFI + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j])
            * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))
          + ((day5[dayFJ + i]
    ...
    for i in 0..<365 {
      day7[dayML + i] = iff(
      or(
     day1[dayKD + i].isZero, day1[dayKS + i].isZero),0, min((day5[dayGE + i] + (day1[dayIA + i] - day5[dayGE + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKD + i] - equiv_harmonious_min_perc[j])) + ((day5[dayGF + i] + (day1[dayIB + i] - day5[dayGF + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKD + i] - equiv_harmonious_min_perc[j])) - (day5[dayGE + i] + (day1[dayIA + i] - day5[dayGE + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKD + i] - equiv_harmonious_min_perc[j]))) / (Overall_harmonious_max_perc - Overall_harmonious_min_perc) * (day1[dayKS + i] - Overall_harmonious_min_perc),max(0, -(day1[dayMJ + i] + day1[dayMK + i] - day1[dayMD + i] - day1[dayME + i] - day7[dayMF + i] - day1[dayMG + i] - day1[dayMH + i] - day1[dayMI + i]))))
    }
    ...
    for i in 0..<365 {
      day7[dayMM + i] =
        day1[dayMJ + i] + day1[dayMK + i] + day1[dayML + i] - day1[dayMD + i] - day1[dayME + i]
        - day7[dayMF + i] - day1[dayMG + i] - day1[dayMH + i] - day1[dayMI + i]
    }
    ...
    for i in 0..<365 {
      day7[dayMP + i] = iff(
        or(day1[dayKS + i].isZero, day1[dayKD + i].isZero), 0, day1[dayMH + i] * El_boiler_eff)
    }
    ...
    for i in 0..<365 {
      day7[dayMS + i] =
        day1[dayMP + i] + day7[dayMQ + i] + day1[dayMR + i] - day1[dayMN + i] - day1[dayMO + i]
    }
    ...
    let dayMW = 38690
    // MG6*BESS_chrg_eff
    for i in 0..<365 { day7[dayMW + i] = day1[dayMG + i] * BESS_chrg_eff }
    ...
    for i in 0..<365 {
      day7[dayMY + i] = iff(
      or(
     day1[dayKS + i].isZero, day1[dayKD + i].isZero),0, min(day5[dayGG + i] + (day1[dayIC + i] - day5[dayGG + i]) / (day1[dayAM + i] - equiv_harmonious_min_perc[j]) * (day1[dayKD + i] - equiv_harmonious_min_perc[j]),max(0, -(day1[dayMW + i] + day1[dayMX + i] - day1[dayMT + i] - day1[dayMU + i] - day7[dayMV + i]))))
    }
    ...
    for i in 0..<365 {
      day7[dayMZ + i] =
        day1[dayMW + i] + day1[dayMX + i] + day1[dayMY + i] - day1[dayMT + i] - day1[dayMU + i]
        - day7[dayMV + i]
    }
    ...
    for i in 0..<365 {
      day7[dayNB + i] = iff(
        or(day1[dayKS + i].isZero, day1[dayKD + i].isZero), 0, day7[dayMV + i] * El_boiler_eff)
    }
    ...
    let dayND = 41245
    // NB6+NC6-NA6
    for i in 0..<365 { day7[dayND + i] = day1[dayNB + i] + day1[dayNC + i] - day1[dayNA + i] }
    ...
    for i in 0..<365 {
      day7[dayNE + i] =
        iff(
          day1[dayMD + i] <= 0, 0,
          day1[dayMD + i] / (Overall_harmonious_var_max_cons + Overall_fix_cons) * MethDist_harmonious_max_perc
            * MethDist_Meth_nom_prod_ud)
        + iff(
          day1[dayMT + i] <= 0, 0,
          (day1[dayMT + i] - overall_stup_cons[j]) / (overall_var_max_cons[j] + overall_fix_stby_cons[j])
            * MethDist_max_perc[j] * MethDist_Meth_nom_prod_ud)
    }
    ...
    let dayNG = 42340
    // MY6+ML6
    for i in 0..<365 { day7[dayNG + i] = day1[dayMY + i] + day1[dayML + i] }
    ...
    for i in 0..<365 {
      day7[dayNK + i] =
        max(0, -day1[dayMM + i]) + max(0, -day7[dayMS + i]) + max(0, -day7[dayMZ + i])
        + max(0, -day1[dayND + i])
    }
    return day7
  }
