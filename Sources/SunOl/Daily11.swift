extension TunOl {
  func d15(_ d15: inout [Double], hour0: [Double], hour2: [Double], hour3: [Double], d11: [Double]) {
    ...
    do {
      ...
      for i in 0..<365 { d15[EY + i] = CS_CQ_Lsum[i] + CS_CC_CQ_BXsum[i] - CS_CQ_CIsum[i] }
    }
    do {
      ...
      //+SUMIFS(CalculationBX5:BX8763,CalculationCC5:CC8763,">0",CalculationCS5:CS8763,"="A6,CalculationCQ5:CQ8763,"=0")
      //-SUMIFS(CalculationCI5:CI8763,CalculationCS5:CS8763,"="A6,CalculationCQ5:CQ8763,"=0")
      for i in 0..<365 { d15[EZ + i] = CS_CQ_Lsum[i] + CS_CC_CQ_BXsum[i] - CS_CQ_CIsum[i] }
    }
    ...
    do {
      ...
      for i in 0..<365 { d15[FA + i] = CS_CQ_Jsum[i] + CS_CC_CQ_CBsum[i] / PB_Ratio_Heat_input_vs_output - CS_CQ_CJsum[i] }
    }
    do {
      ...
      //+SUMIFS(CalculationCB5:CB8763,CalculationCC5:CC8763,">0",CalculationCS5:CS8763,"="A6,CalculationCQ5:CQ8763,"=0")/PB_Ratio_Heat_input_vs_output
      //-SUMIFS(CalculationCJ5:CJ8763,CalculationCS5:CS8763,"="A6,CalculationCQ5:CQ8763,"=0")
      for i in 0..<365 { d15[FB + i] = CS_CQ_Jsum[i] + CS_CC_CQ_CBsum[i] / PB_Ratio_Heat_input_vs_output - CS_CQ_CJsum[i] }
    }
    ...
    for i in 0..<365 { d15[FC + i] = CQsum[i] + CS_CQ_CTsum[i] }
    ...
    for i in 0..<365 { d15[FD + i] = DHsum[i] + CS_DH_CTsum[i] }
    ...
    for i in 0..<365 { d15[FE + i] = CS_CQ_CTsum2[i] }
    ...
    for i in 0..<365 { d15[FF + i] = CRsum[i] + CS_CQ_CUsum[i] }
    ...
    for i in 0..<365 { d15[FG + i] = DIsum[i] + CS_DH_CUsum[i] }
    ...
    for i in 0..<365 { d15[FH + i] = CS_CQ_CUsum2[i] }
    ...
    for i in 0..<365 { d15[FI + i] = CS_CQ_CXsum[i] }
    ...
    for i in 0..<365 { d15[FJ + i] = CS_DH_DLsum[i] }
    ...
    for i in 0..<365 { d15[FK + i] = CXsum[i] - d15[FI + i] }
    ...
    for i in 0..<365 { d15[FL + i] = CS_CQ_CZsum[i] }
    ...
    for i in 0..<365 { d15[FM + i] = CS_DH_DNsum[i] }
    ...
    for i in 0..<365 { d15[FN + i] = CZsum[i] - d15[FL + i] }
    ...
    for i in 0..<365 { d15[FO + i] = CS_CQ_CMsum[i] }
    ...
    for i in 0..<365 { d15[FP + i] = CMsum[i] - d15[FO + i] }
    ...
    for i in 0..<365 { d15[FQ + i] = CS_CQ_CNsum[i] }
    ...
    for i in 0..<365 { d15[FR + i] = CNsum[i] - d15[FQ + i] }
    ...
    for i in 0..<365 { d15[FS + i] = CS_CQ_CVsum[i] }
    ...
    for i in 0..<365 { d15[FT + i] = CS_DH_DJsum[i] }
    ...
    for i in 0..<365 { d15[FU + i] = CVsum[i] - d15[FS + i] }
    ...
    for i in 0..<365 { d15[FV + i] = CS_CQ_CWsum[i] }
    ...
    for i in 0..<365 { d15[FW + i] = CS_DH_DKsum[i] }
    ...
    for i in 0..<365 { d15[FX + i] = CWsum[i] - d15[FV + i] }
    ...
    for i in 0..<365 { d15[FY + i] = min(CS_CQ_DEsum[i], BESS_cap_ud / BESS_chrg_eff) }
    ...
    for i in 0..<365 { d15[FZ + i] = min(CS_DH_DSsum[i], BESS_cap_ud / BESS_chrg_eff) }

    /// Max BESS night prep outside of harm op period
    let GA = 10220
    let CS_CQ_DEsum2 = hour3.sumOf(DE, days: daysCS, condition: CQ, predicate: { $0.isZero })
    // MIN(SUMIFS(CalculationDE5:DE8763,CalculationCS5:CS8763,"="A6,CalculationCQ5:CQ8763,"=0"),BESS_cap_ud/BESS_chrg_eff)
    for i in 0..<365 { d15[GA + i] = min(CS_CQ_DEsum2[i], BESS_cap_ud / BESS_chrg_eff) }
    ...
    for i in 0..<365 { d15[GB + i] = CS_CQ_DFsum[i] }
    ...
    for i in 0..<365 { d15[GC + i] = CS_DH_DTsum[i] }
    ...
    for i in 0..<365 { d15[GD + i] = DFsum[i] - d15[GB + i] }
    ...
    for i in 0..<365 { d15[GE + i] = CS_CQ_CYsum[i] }
    ...
    for i in 0..<365 { d15[GF + i] = CS_DH_DMsum[i] }
    ...
    for i in 0..<365 { d15[GG + i] = CYsum[i] - d15[GE + i] }
    ...
    for i in 0..<365 { d15[GH + i] = CS_CQ_DAsum[i] }
    ...
    for i in 0..<365 { d15[GI + i] = CS_DH_DOsum[i] }
    ...
    for i in 0..<365 { d15[GJ + i] = DAsum[i] - d15[GH + i] }
    ...
    for i in 0..<365 { d15[GK + i] = CS_CQ_DBsum[i] }
    ...
    for i in 0..<365 { d15[GL + i] = CS_DH_DPsum[i] }
    ...
    for i in 0..<365 { d15[GM + i] = DBsum[i] - d15[GK + i] }
    ...
    for i in 0..<365 { d15[GN + i] = CS_CQ_DCsum[i] }
    ...
    for i in 0..<365 { d15[GO + i] = CS_DH_DQsum[i] }
    ...
    for i in 0..<365 { d15[GP + i] = DCsum[i] - d15[GN + i] }
    ...
    for i in 0..<365 { d15[GQ + i] = CS_CQ_DDsum[i] }
