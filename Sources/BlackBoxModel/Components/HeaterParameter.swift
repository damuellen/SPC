...
extension Heater.Parameter: CustomStringConvertible {
  ...
  public var description: String {
    "Description:" * name + "Capacity of HTF-Heater [MW]:"
      * Design.layout.heater.description + "Efficiency [%]:"
      * efficiency.percentage.description
...
extension Heater.Parameter: TextConfigInitializable {
  ...
  init(file: TextConfigFile) throws {
    ...
    self = try .init(
      name: file.name, efficiency: Ratio(ln(10) / 100),
      minLoad: Ratio(ln(25) / 100), maximumMassFlow: ln(22),
      ...
      electricalParasitics: [ln(31), ln(34)], onlyWithSolarField: true)
  }
}
