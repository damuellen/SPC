...
public enum DryCooling {
  ...
  static func perform(steamTurbineLoad: Ratio, temperature: Temperature) -> (
    ...
    let pressureCondMin = 0.179
    let pressureCondMax = 0.421  // [bar]

    // Define constants for minimum and maximum Heat Rate Factors
    let HRFmin = 98.0
    let HRFmax = 106.8  // [%] of design
    ...
    func saturationPressure(_ temperature: Temperature) -> Pressure {
      ...
      let coefficients = [
        10.4592, -0.00404897, -0.000041752, 3.6851e-07, -1.0152e-09,
        8.6531e-13, 9.03668e-16, -1.9969e-18, 7.79287e-22, 1.91482e-25,
        -3968.06, 39.5735,
      ]
      ...
      let logpsat =
        fit + coefficients[10] / (temperature.kelvin - coefficients[11])
      return exp(logpsat)
    }
