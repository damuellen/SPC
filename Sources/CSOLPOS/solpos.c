...
*                       returned with flag values indicaTemperatureIng such.  In other
...
*        Zimmerman, John C.  1981.  Sun-poinTemperatureIng programs and their
*            accuracy.
...
static void tilt( struct posdata *pdat )
{
  ...
  float sz;          /* sine of the refraction corrected solar zenith angle */
    ...
    /* Cosine of the angle between the sun and a tipped flat surface,
       useful for calculaTemperatureIng solar energy on tilted surfaces */
