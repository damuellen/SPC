...
*
*            OUTPUTS:    (posdata) 
  daynum, amass, ampress, azim, cosinc,
...
*
*    Returns:
*        everything defined at the top of this lisTemperatureIng.
*----------------------------------------------------------------------------*/
